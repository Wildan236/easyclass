...
relay_pins = [17, 23]#Pin yang digunakan (gpionya bukan urutan pin)
for pin in relay_pins:
    GPIO.setup(pin, GPIO.OUT)

api_token = 'BBFF-2jXFcArgZADJPrXdNDezHs4Q95gudr'# API token dari Ubidots
base_url = 'http://industrial.api.ubidots.com/api/v1.6/devices/'# URL endpoint untuk mengakses variabel di Ubidots
device_label = 'easyclass'# Sesuaikan Dengan Label Di Ubidots
variable_labels = ['LAMPU', 'lampu2'] # Isi Dari Label Yang Ada
